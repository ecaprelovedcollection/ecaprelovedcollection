    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">eca preloved collection</a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li>
							<a href="tampil-mahasiswa.php"><span class="glyphicon glyphicon-user"></span> data barang</a>
						</li>
            <li>
							<a href="tampil-nilai.php"><span class="glyphicon glyphicon-user"></span> data pembeli</a>
						</li>
            <li>
							<a href="contact.php"><span class="glyphicon glyphicon-user"></span> Kritik dan Saran</a>
						</li>
            <li>
							<a href="tampil-berita.php"><span class="glyphicon glyphicon-user"></span> pesan barang</a>
						</li>
            <li>
